...
namespace MuqDice
{
	public static class MongoHelper
	{
        static MongoHelper()
        {
            ...
            ConventionPack conventionPack = new ConventionPack { new IgnoreExtraElementsConvention(true), new IgnoreIfDefaultConvention(true) };
	        
	        ConventionRegistry.Register("IgnoreExtraElements", conventionPack, type => true);

            ConventionRegistry.Register("IgnoreIfDefault", conventionPack, type => true);
